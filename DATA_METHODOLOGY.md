...
|------|------|---------|-------|-----------------|
| `audited_demographics_normalized.json` | 4,811 | 269 | 1990–2023 observed; 2024–2025 projected | U.S. Census Decennial (1990, 2000, 2010, 2020), American Community Survey 5-year estimates (2005–2023) |
| `audited_property_normalized.json` | 2,645 | 209 | 1990–2023 observed; 2024–2025 projected | Travis Central Appraisal District (TCAD), MLS records, Zillow Home Value Index |
| `audited_socioeconomic_normalized.json` | 2,544 | 209 | 1990–2023 observed; 2024–2025 projected | Census/ACS, Bureau of Labor Statistics, Texas HHSC (SNAP), Eviction Lab (Princeton), Texas Justice Court Training Center |

**Important:** Data for 1990–2023 comes from observed Census, ACS, and administrative records. Values for 2024–2025 are projections based on trend extrapolation and are flagged with lower audit confidence scores (see §9.1). Intermediate years between Census snapshots (e.g., 1995, 2005) are linearly interpolated and flagged with `INTERPOLATED` audit flag.

**Geography:** 269 census tracts covering the Austin-Round Rock MSA, mapped to the 2020 Census tract boundaries. Pre-2010 data is crosswalked from earlier tract definitions (boundary changes noted with `TRACT_MISMATCH` audit flag). See §10 for details on geographic imprecision in pre-2010 comparisons.
...
|-----------|----------------|----------|-------|
| Demographics | 269 | 100% | All regions, all years 1990–2023 |
| Property | 209 | 78% | Missing for 60 regions (mostly rural/ETJ tracts with sparse housing stock) |
| Socioeconomic | 209 | 78% | Same 60-region gap as property |
